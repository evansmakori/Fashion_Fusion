...
export default class extends Service<Env> {
  ...
  // RPC methods for service-to-service calls
  async saveProduct(params: any): Promise<any> {
    return {
      savedProductId: params.productId,
  ...
  async getProductsByCategory(params: any): Promise<any> {
    return {
      categoryId: params.categoryId,
  ...
  async getProductDetails(params: any): Promise<any> {
    if (params.productId === 'invalid_prod') {
  ...
  async deleteProduct(params: any): Promise<any> {
    return {
      success: true,
